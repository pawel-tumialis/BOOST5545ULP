...
Uint32 tab_br_buf[SAMPLE_NUMBER];                           // Pamiec ta wydzielono w pliku linkera lnkx.cmd

Uint32 tab_scratch_buf[SAMPLE_NUMBER];
...
Uint16 hwafft_1024pts(Int32_ *data, Int32_ *scratch, Uint16 fft_flag, Uint16 scale_flag);
Uint16 hwafft_512pts(Int32_ *data, Int32_ *scratch, Uint16 fft_flag, Uint16 scale_flag);
Uint16 hwafft_128pts(Int32_ *data, Int32_ *scratch, Uint16 fft_flag, Uint16 scale_flag);
Uint16 hwafft_64pts(Int32_ *data, Int32_ *scratch, Uint16 fft_flag, Uint16 scale_flag);
Uint16 hwafft_32pts(Int32_ *data, Int32_ *scratch, Uint16 fft_flag, Uint16 scale_flag);
Uint16 hwafft_16pts(Int32_ *data, Int32_ *scratch, Uint16 fft_flag, Uint16 scale_flag);
Uint16 hwafft_8pts(Int32_ *data, Int32_ *scratch, Uint16 fft_flag, Uint16 scale_flag);
...
TEST_STATUS initialize_dma(void){
    // Interrupt configuration
        ...
        dmaConfig.dataLen      = SAMPLE_NUMBER;
    ...
    if (ifrValue & (1<<4))
    {
        if(startFFT == 1){
            ...
            for (jj=0; jj<SAMPLE_NUMBER; jj++)   {   //  kopiowanie danych wejsciowych
                    ...
                    hwafft_br(data, data_br, SAMPLE_NUMBER); /* bit-reverse input data,
